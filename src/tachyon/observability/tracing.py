"""OpenTelemetry distributed tracing for Tachyon tunnel application.
...
ATTR_TUNNEL_ID = "tachyon.tunnel.id"
ATTR_SUBDOMAIN = "tachyon.subdomain"
ATTR_PROTOCOL = "tachyon.protocol"
ATTR_CLIENT_IP = "tachyon.client.ip"
ATTR_REQUEST_ID = "tachyon.request.id"
ATTR_ERROR_TYPE = "tachyon.error.type"
ATTR_BYTES_SENT = "tachyon.bytes.sent"
ATTR_BYTES_RECEIVED = "tachyon.bytes.received"


class TachyonTracer:
    """OpenTelemetry tracer for Tachyon application.
...
def setup_tracing(
    ...
    Returns:
        Configured TachyonTracer instance
    """
...
def get_tracer() -> TachyonTracer:
    """Get the global TachyonTracer instance.

    Returns:
        TachyonTracer singleton
    """
    return TachyonTracer()
...
class TracingMiddleware:
    ...
    def __init__(
        self,
        app: Any,
        tracer: TachyonTracer | None = None,
    ) -> None:
        """Initialize middleware.

        Args:
            app: ASGI application
            tracer: TachyonTracer instance
        """
        self.app = app
