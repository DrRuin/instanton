"""Authentication middleware for Tachyon.
...
from tachyon.auth.providers import AuthProvider, AuthResult, AuthType

if TYPE_CHECKING:
    from tachyon.auth.permissions import Permission
...
AUTH_CONTEXT_KEY = "tachyon_auth_context"
