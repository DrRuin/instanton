"""High-performance transport layer for Tachyon tunnel.
...
from tachyon.core.performance import (
    get_buffer_pool,
...
class QuicConfig:
    ...
    alpn_protocols: list[str] = field(default_factory=lambda: ["tachyon", "h3"])
