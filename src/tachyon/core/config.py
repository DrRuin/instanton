...
class AuthConfig(BaseModel):
    ...
    jwt_issuer: str = "tachyon"
    jwt_audience: str = "tachyon"
    ...
    # Storage settings
    sqlite_path: str = "tachyon_auth.db"
...
class ClientConfig(BaseModel):
    ...
    server_addr: str = "tachyon.dev:443"
    local_port: int = 8080
